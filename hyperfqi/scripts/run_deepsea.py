...
from hyperfqi.data import Collector, ReplayBuffer
from hyperfqi.env import DummyVectorEnv
from hyperfqi.env.utils import make_env
...
def get_args():
    ...
    parser.add_argument('--target-noise-coef', type=float, default=0.0001)
    ...
    parser.add_argument('--bias-init', type=str, default="sphere", choices=["sphere", "xavier_normal"])
    # epoch config
    ...
    # other confing
    parser.add_argument('--logdir', type=str, default='~/results/hyperfqi/sample')
...
def main(args=get_args()):
    ...
    # you can also use hyperfqi.env.SubprocVectorEnv
    ...
    train_collector = Collector(
        policy, train_envs, buffer, exploration_noise=False,
