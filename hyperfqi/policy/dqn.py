...
class DQNPolicy(BasePolicy):
    ...
    :param torch.nn.Module model: a model following the rules in
        :class:`~hyperfqi.policy.BasePolicy`. (s -> logits)
    ...
    .. seealso::
        ...
        Please refer to :class:`~hyperfqi.policy.BasePolicy` for more detailed
        explanation.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.clip_value = len(value_range) == 2
    ...
    def process_fn(
        ...
        :meth:`~hyperfqi.policy.BasePolicy.compute_nstep_return`.
        """
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        :return: A :class:`~hyperfqi.data.Batch` which has 3 keys:
        ...
        .. seealso::
            ...
            Please refer to :meth:`~hyperfqi.policy.BasePolicy.forward` for
