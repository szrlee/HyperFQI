...
class VectorReplayBuffer(ReplayBufferManager):
    ...
    are the same as :class:`~hyperfqi.data.ReplayBuffer`.

    .. seealso::

        Please refer to :class:`~hyperfqi.data.ReplayBuffer` for other APIs' usage.
    """
...
class PrioritizedVectorReplayBuffer(PrioritizedReplayBufferManager):
    ...
    sample_avail) are the same as :class:`~hyperfqi.data.PrioritizedReplayBuffer`.
